...
#define CLIENT_VERSION "GridDB Client 0.5.0"
...
namespace griddb {
	...
	public:
		...
		static shared_ptr<StoreFactory> get_default();
		shared_ptr<Store> get_store(const GSPropertyEntry* props, int propsCount);
